...
export const demos: DemoMeta[] = [
  ...
  { id: "evals", name: "Evals", value: "Before shipping the IAM Policy Generator above, I built this: an 8-case eval suite that regenerates and grades those same AI policies against deterministic pass or fail rubrics, live, so you can watch the testing, not just the output." },
];
