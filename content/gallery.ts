...
export const demos: DemoMeta[] = [
  ...
  { id: "website-planner", name: "Multi-Agent Website Planner", value: "Watch three AI agents collaborate live — supervisor, UX planner, copywriter — turning a one-line brief into a full sitemap + section copy.", flagship: true, href: "https://web-planner-delta.vercel.app", external: true },
